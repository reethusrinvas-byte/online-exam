(() => {
  ...
  function highlightPalette(i){ for(let k=0;k<paletteArea.children.length;k++){ paletteArea.children[k].classList.remove('current'); } if(paletteArea.children[i]) paletteArea.children[i].classList.add('current'); }
